...
public class DistrictWiseDataActivity extends AppCompatActivity {
    ...
    private com.example.covid_19tracker.Adapters.DistrictWiseAdapter districtWiseAdapter;
    ...
    private void Init() {
        ...
        districtWiseAdapter = new com.example.covid_19tracker.Adapters.DistrictWiseAdapter(DistrictWiseDataActivity.this, districtWiseModelArrayList);
